...
public class TestChallenge {
	...
	public void setUp() throws Exception {
		c = new Challenge.Builder().addIncorrectAnswer("3").correctAnswer("4")
				.question("?").build();
	}

	@Test
	public void testBuilder() {
		Challenge cTmp = new Challenge.Builder()
				.correctAnswer("correct")
				.challengeReward(
						new ChallengeReward(50, "Good job!", Optional
								.<Image> absent())).question("?").build();
